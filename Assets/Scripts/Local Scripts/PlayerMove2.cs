...
public class PlayerMove2 : MonoBehaviour
{
    ...
    public void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.tag == "Player")
        {
            ...
            if (dodgeTimer > .1f && dodgeTimer < 1f && enemyPlayer.GetComponent<PlayerMove1>().isBlocking == true)
            {
                ...
                enemyPlayer.GetComponent<PlayerMove1>().isStunnedCounter += 1;
                enemyPlayer.GetComponent<PlayerMove1>().isStunned = true;
                enemyPlayer.GetComponent<PlayerMove1>().ForceUnblock();
    ...
    public void Movement()
    {
        ...
        if (isDodging == false)
        {
            ...
            float xDirection = Input.GetAxisRaw("Horizontal1");
